...
export default function Home() {
  ...
  const currentResults = BitcoinEconomicsModel.computeFullModel(
    updatedInputs,
    true
  );

  // Calculate post-reward state (fees only)
  const postRewardResults = BitcoinEconomicsModel.computeFullModel(
    updatedInputs,
    false
  );
